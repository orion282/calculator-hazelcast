...
4. Déployer avec Ansible: dans le doc "Description_platforme", les playbooks utilisés sont décrits en détails. Utiliser le commande "ansible-playbook -i inventory_file playbook_file" pour les exécuter
